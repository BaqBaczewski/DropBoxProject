...
public class FeedServiceTests {
    ...
    public void testFeeds() {
        ...
        Sound u3s1 = soundService.create("U3S1", dummyAudioData(), 4, user3, later());
        ...
        Sound u4s1 = soundService.create("U4S1", dummyAudioData(), 4, user4, later());
        Sound u4s2 = soundService.create("U4S2", dummyAudioData(), 4, user4, later());
        assertThat(feedService.getFeed(user1, PageRequest.of(0, 10))).containsExactly(u2s2, u3s1, u2s1);
        ...
        Sound u2s3 = soundService.create("U2S3", dummyAudioData(), 4, user2, later());
        Sound u2s4 = soundService.create("U2S4", dummyAudioData(), 4, user2, later());
        assertThat(feedService.getFeed(user1, PageRequest.of(0, 10))).containsExactly(u4s2, u4s1, u3s1);
